/**
 * Created by arkeros on 08/03/2017.
 */
...
const websocketsConfig = {
  ...
  entry: {
    websockets: ['babel-polyfill', './src/websockets.js'],
  },
...
export default [clientConfig, webConfig, websocketsConfig];
